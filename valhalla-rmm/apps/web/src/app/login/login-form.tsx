    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-950 p-4">
      <div className="w-full max-w-sm space-y-6">
        <div className="text-center">
          ...
          <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Valhalla RMM</h1>
          <p className="text-sm text-slate-500 mt-1">Staff &amp; technician login</p>
        </div>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 border border-slate-200 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-800 py-2.5 rounded-lg text-sm font-medium transition-colors"
        >
        ...
        <p className="text-center text-xs text-slate-400">
          Are you a client?{' '}
          <a href="/portal/login" className="text-amber-500 hover:underline">
            Client portal login →
          </a>
        </p>
      </div>
